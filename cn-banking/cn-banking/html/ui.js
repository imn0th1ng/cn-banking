...
document.onkeyup = function (data) {
    if (data.which == 27) {
        $("#transaction").empty();
        $.post('http://cn-banking/close', JSON.stringify({}));
...
$('.w-okay').click(function (e) {
    ...
    if (wvalue == "") {
        ...
        $.post('http://cn-banking/withdraw', JSON.stringify({
            value: wvalue,
            comment: wcomment
        })
        );
...
$('.d-okay').click(function (e) {
    ...
    if (dvalue == "") {
        ...
        $.post('http://cn-banking/deposit', JSON.stringify({
            value: dvalue,
            comment: dcomment
        })
        );
...
$('.t-okay').click(function (e) {
    ...
    if (tvalue == "" && tcomment =="") {
        ...
        $.post('http://cn-banking/transfer', JSON.stringify({
            value: tvalue,
            comment: tcomment,
            id: tid
        })
